package org.easysoc.plugins.diagrammer.util;
...
public class CheckLicense {
   ...
   */
  private static final String PRODUCT_CODE = "PDIAGRAMMER";
  ...
  @NotNull
  public static DataContext asDataContext(@Nullable String message) {
    return dataId -> {
      switch (dataId) {
        // the same code as registered in plugin.xml, 'product-descriptor' tag
        case "register.product-descriptor.code" : return PRODUCT_CODE;
